...
dbt_antlr4::impl_parser_recog! { VisitorCalcParserExt, VisitorCalcParserNodeKind, "VisitorCalc.g4"; sempred (VisitorCalcParserNode<'input, 'arena, TF::Tok>, VisitorCalcParser) { 1 => expr_sempred, } }
...
dbt_antlr4::impl_ctx! { VisitorCalcParserNodeKind, SContext, SContextExt, RULE_s }
...
dbt_antlr4::impl_ctx! { @labeled VisitorCalcParserNodeKind::ExprContext, ExprContextAll, ExprContextExt, RULE_expr }
...
dbt_antlr4::impl_ctx! { @alt VisitorCalcParserNodeKind::ExprContext, ExprContextAll::AddContext, AddContextExt, RULE_expr }
...
dbt_antlr4::impl_ctx! { @alt VisitorCalcParserNodeKind::ExprContext, ExprContextAll::NumberContext, NumberContextExt, RULE_expr }
...
dbt_antlr4::impl_ctx! { @alt VisitorCalcParserNodeKind::ExprContext, ExprContextAll::MultiplyContext, MultiplyContextExt, RULE_expr }
    ...
    Input: TokenStream<'input, 'arena, TF> + 'arena,
{
	...
	fn expr_rec(&mut self, _p: i32) -> Result<&'arena ExprContextAll<'input, 'arena, TF::Tok>, ANTLRError> {
        dbt_antlr4::parse_rule!(rec recog = self, _parentctx, _parentState, ExprContext<TF::Tok>, RULE_expr, 2, |_parentctx| ExprContextExt::create(recog.get_arena(), _parentctx, recog.get_state()); _p; {
...
static _serializedATN: [&'static str; 4] = [
    "CAIMLAQADgAEAg4CAgACAAIAAgICAgICAgICAgICAgICAgICCgIiEAIUAhgCKBICAgIAAgQEAAQABAIA",
    "BAYCAAgKKgAIAgAAAAQOAgAAAAgKBgQCAAoMCgAAAgwCAgAAAA4QDAIBABASCgIAABIkAgAAABQWFAQA",
    "ABYYDgAAABgiBgQCBhocFAIAABweDgIAAB4iBgQCBCAUAgAAACAaAgAAACIoAgAAACQgAgAAACQmAgAA",
    "ACYGAgAAACgkAgAAAAQgJA=="
];