...
impl<'input: 'arena, 'arena, Tok: Token + 'input> SelectContextExt<'input, 'arena, Tok> {
	...
	fn copy_from(src: &mut ParenExprParserNode<'input, 'arena, Tok>) {
        ...
        *dbt_antlr4::cast_unchecked!(src => mut QContextAll<'input, 'arena, Tok>) = ctx;
        src.set_invoking_state(invoking_state);
        src.node_tag = <Self as CustomRuleContext<'input, 'arena, Tok>>::node_tag();
	}
}
...
static _serializedATN: [&'static str; 16] = [
    "CAIWcgQADgAEAg4CBAQOBAIAAgACAAICAgICAgICAgICAgICCAIiEAIWAhgCJAICAgICAgICAgICAgIC",
    "AgICAgICAgICAgYCQhACAgICAgICAgICAgICCgJSEAIUAhgCWBICAgQCBAIEAgQCBAIEAgQGBGoQBAIE",
    "AgICAgACBAYABAgABAIACgwEAAgIDg6AAQAMAgAAAARAAgAAAAhoAgAAAAwOBgQCAA4QCgAAAhACAgAA",
    "ABIUDAIBABRCChQAABZCChIAABgaCgIAABogBgQCABweCgQAAB4iBgQCACAcAgAAACIkAgAAACQgAgAA",
    "ACQmAgAAACYoAgAAACgqCgYAACpCAgAAACwuCgIAAC4wBgQCADAyCgYAADJCAgAAADQ2CgIAADY4BggE",
    "ADg6CgYAADpCAgAAADw+CggAAD5CBgQCBkASAgAAAEAWAgAAAEAYAgAAAEAsAgAAAEA0AgAAAEA8AgAA",
    "AEJUAgAAAERGFAQAAEZIDgAAAEhSBgQCBkpMFAIAAExODgIAAE5SBgQCBFBEAgAAAFBKAgAAAFJYAgAA",
    "AFRQAgAAAFRWAgAAAFYGAgAAAFhUAgAAAFpcChAAAFxqChIAAF5qChIAAGBiCgIAAGJkBggEAGRmCgYA",
    "AGZqAgAAAGhaAgAAAGheAgAAAGhgAgAAAGoKAgAAAG4gAgAAAG4wAgAAAHBuBgQCAAokQFBUaAwKCAJE",
    "9gEAAAwEAgAACgAAAQAAAAAAAAYBAAgAAQABAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA",
    "AAAAAAAAAAAAAAAYNjY2NlRmZniKAYoBnAGiAbQBxgHkAeQB5AHkAfYB9gH2AfYB9gH2AfYB9gH2AfYB",
    "9gH2AfYB9gH2AQICAggIBBISBhQUCAICCggIDBAQDhISEBQUEgICFAgIFhAQGBISGhQUHAICHggIIBIU",
    "EgQEIgYGJAgOJgQEIgYGKAgOJgICKggIIBIUHBISLAQELgYGMAgOMgQELgYGNAgOMgICNggIIBAQOBIS",
    "OhQUPAICPggIQBIUQhggBAYIKgQGCC4EBggyBAYINAQGCDYEBgg4BAYIOgQGCDwEBgg+BAYIQAQGCEIE",
    "BggEBhIABAIAAAAAEhISCAgCCgwEDg4CAAEKGAAEBAQCBAAAAAAAGBgYGBgBAQIEBAQGBgYIDggAAQwk",
    "AAQEBAQCBAAAAAAAACQkJCQkJAEBAgQEBAYGBggICAoMCg4OCAABAgAEAAAAAAIGBAIEBAYI"
];